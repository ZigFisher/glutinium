...
void lcd_ili9342c_init_horizontal_all(void)
{
    ...
    ssp_write_cmd(0xB0); //set DEN, DOCLK, HSYNC, VSYNC, adjust according to IC
    ssp_write_dat(0xEC);//40,42,60,62,

    ssp_write_cmd(0x0c);
    ssp_write_dat(0x00);
    ssp_write_dat(0xd5);

    ssp_write_cmd(0xF6);//set RGB mode or VSYNC mode interface, 16 or 18BIT .
