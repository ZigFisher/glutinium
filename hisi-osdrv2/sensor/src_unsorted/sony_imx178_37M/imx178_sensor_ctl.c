...
void sensor_init_5M30()
{
    ...
    sensor_write_register (0x302C, 0xAB);
    sensor_write_register (0x302D, 0x09); /* VMAX */
    ...
    sensor_write_register (0x33BE, 0x18);
    sensor_write_register (0x33BF, 0x18);
    sensor_write_register (0x33C0, 0x20);
    sensor_write_register (0x33C1, 0x20);
    sensor_write_register (0x33C2, 0x18);
    sensor_write_register (0x33C3, 0x20);
    sensor_write_register (0x33C4, 0x20);
...
void sensor_init_1080p60()
{
    ...
    sensor_write_register (0x302C, 0x72);
    sensor_write_register (0x302D, 0x06); /* VMAX */
