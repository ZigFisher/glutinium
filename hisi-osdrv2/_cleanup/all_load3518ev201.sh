#!/bin/sh
# Useage: ./load3518ev201 [ -r|-i|-a ] [ sensor ]
#         -r : rmmod all modules
#         -i : insmod all modules
#    default : rmmod all moules and then insmod them
#
# for hi3518ev201 32M ddr

# 9m034 ar0130 ar0230 imx222 mn34222 ov9712 ov9732 ov9750 ov9752
...
SNS_TYPE=ar0130             # sensor type

mem_total=32;               # 32M, total mem
mem_start=0x80000000;       # phy mem start

os_mem_size=21;             # 21M, os mem
mmz_start=0x82000000;       # mmz start addr
mmz_size=11M;               # 11M, mmz size
...
insert_ko()
{
	...
	# hi3518ev201 don't insmod vgs/hifb/ive default
	...
	insmod hi3518e_h264e.ko H264eRcnEqualRef=1
	insmod hi3518e_jpege.ko
	#insmod hi3518e_ive.ko save_power=1;
...
load_usage()
{
	echo "Usage:  ./load3518ev201 [-option] [sensor_name]"
	echo "options:"
	...
	echo -e "Available sensors: 9m034 ar0130 ar0230 imx222 mn34222 ov9712 ov9732 ov9750 ov9752"
	echo -e "notes: osmem option can't be used when mmz zone partition is enable\n\n"
	echo -e "for example online:   ./load3518ev201 -a -sensor ar0230 -osmem 32 -total 64\n"
	echo -e "            offline:  ./load3518ev201 -a -sensor ar0230 -osmem 32 -total 64 -offline\n"
}
