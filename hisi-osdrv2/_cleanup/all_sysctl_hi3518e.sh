...
# ive utili 
#himm 0x206A0000	0x2			# Open utili statistic                   !!! Open in restrim firmware
#himm 0x206A0080 0x11E1A300  		        # Utili peri,default 0x11E1A300 cycle    !!! Open in restrim firmware
