...
insert_sns()
{
	if [ "$SNS_TYPE" == "auto" ]; then
		$IPCAM_HOME/detectsns
		ENV_SENSORTYPE=`fw_printenv sensortype`
		if [ -n "$ENV_SENSORTYPE" ]; then
			SNS_TYPE=${ENV_SENSORTYPE:11}
		else
			SNS_TYPE=imx122
		fi
	fi
	...
	case $SNS_TYPE in
		ar0237)
			...
			himm 0x20030104 0x1;
			ln -sf $IPCAM_HOME/lib/libar0237.so $IPCAM_HOME/lib/libsensor.so 
			;; 
		ar0230)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			himm 0x2003002c 0xb4005;			# sensor unreset, clk 27MHz, VI 148.5MHz
			himm 0x20030104 0x1;
			ln -sf $IPCAM_HOME/lib/libar0230.so $IPCAM_HOME/lib/libsensor.so 
			;;             
		...
		sc2035)
			...
			ln -sf $IPCAM_HOME/lib/libsc2035.so $IPCAM_HOME/lib/libsensor.so             
			;;  
		sc2135)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			himm 0x2003002c 0xb4001;			# sensor unreset, clk 27MHz, VI 99MHz
			ln -sf $IPCAM_HOME/lib/libsc2135.so $IPCAM_HOME/lib/libsensor.so             
			;;             
		imx122)
			...
			ln -sf $IPCAM_HOME/lib/libsony_imx122.so $IPCAM_HOME/lib/libsensor.so               
			;;
		ov9712)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			ln -sf $IPCAM_HOME/lib/libov9712_plus.so $IPCAM_HOME/lib/libsensor.so            
			;;
		ov2710)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			himm 0x2003002c 0xc4001;			# sensor unreset, clk 24MHz, VI 99MHz        
			ln -sf $IPCAM_HOME/lib/libov2710.so $IPCAM_HOME/lib/libsensor.so 
			;;
		ov9750)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			himm 0x2003002c 0xc4001;			# sensor unreset, clk 24MHz, VI 99MHz
			ln -sf $IPCAM_HOME/lib/libov9750.so $IPCAM_HOME/lib/libsensor.so             
			;; 
		ar0130)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			himm 0x2003002c 0xb4001;			# sensor unreset, clk 27MHz, VI 99MHz
			ln -sf $IPCAM_HOME/lib/libar0130.so $IPCAM_HOME/lib/libsensor.so            
			;;   
		sc1135)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			himm 0x2003002c 0xb4001;			# sensor unreset, clk 27MHz, VI 99MHz
			ln -sf $IPCAM_HOME/lib/libsc1135.so $IPCAM_HOME/lib/libsensor.so            
			;;  
		sc1145)
			himm 0x200f0040 0x2;    			# I2C0_SCL
			himm 0x200f0044 0x2;    			# I2C0_SDA
			...
			ln -sf $IPCAM_HOME/lib/libsc1145.so $IPCAM_HOME/lib/libsensor.so            
			;;
		imx290)
			ln -s $IPCAM_HOME/lib/libsony_imx290.so $IPCAM_HOME/lib/libsensor.so  		
			himm 0x200f0040 0x2;                # i2c0_scl
			himm 0x200f0044 0x2;                # i2c0_sda
			
			himm 0x2003002c 0x94005;            # sensor unreset, clk 37.125MHz, VI 148.5MHz
			himm 0x20030104 0x1;
			;;            
		bt1120)
...
insert_ko()
{
	...
	insmod hi3518e_isp.ko  pwm_num=$iris_pwm
...
#	insmod hi3518e_ive.ko	
	...
	insmod extdrv/wdt.ko default_margin=30 nodeamon=1
	#insert_sns > /dev/null
	insert_sns
	insert_audio
