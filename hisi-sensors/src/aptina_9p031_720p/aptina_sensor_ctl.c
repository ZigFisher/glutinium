...
void sensor_init()
{
	...
	sensor_write_register(0x2C, 0x0012);	//(3) BLUE_GAIN_REG
	sensor_write_register(0x2D, 0x000A);	//(3) RED_GAIN_REG
	...
	usleep(200*1000);
	sensor_write_register(0x05, 0x01C2);	//(1) HORZ_BLANK_REG  450
...
#endif
	sensor_write_register(0x03, 0x02CF);	 	// ROW_WINDOW_SIZE_REG=719
	sensor_write_register(0x04, 0x04FF);	 	// COL_WINDOW_SIZE_REG=1279
	sensor_write_register(0x09, 0x0200);	 	// INTEG_TIME_REG=1024
	...
	sensor_write_register(0x09, 0x02BC);		//(1) INTEG_TIME_REG
...
//	sensor_write_register(0x62, 0x0001);		// Disable analog calibration
//	sensor_write_register(0x60, 0x000f);		// Green1_Offset
//	sensor_write_register(0x61, 0x000f);		// Green2_Offset
//	sensor_write_register(0x63, 0x000f);		// Red_Offset
//	sensor_write_register(0x64, 0x000f);		// Blue_Offset

	printf("Aptina MT9P031 sensor 720P fr(%d) init success!\n", framerate);
}
