...
{
	cmos_inttime.full_lines_std = 1078;
	cmos_inttime.full_lines_std_30fps = 1079;
	cmos_inttime.full_lines = 1078;
	cmos_inttime.full_lines_del = 1078; //TODO: remove
	cmos_inttime.full_lines_limit = 65535;
	cmos_inttime.max_lines_target = 1078;
	cmos_inttime.min_lines_target = 2;
	cmos_inttime.vblanking_lines = 1078;

	cmos_inttime.exposure_ashort = 0;
	cmos_inttime.exposure_shift = 0;

	cmos_inttime.lines_per_500ms = 12764; // 500ms / 39.17us
