...
static AWB_CCM_S g_stAwbCcm =
{
   ...
   2600,
   {     
        0x01b7, 0x8071, 0x8046,
        0x8071, 0x01a7, 0x8036,
        0x800a, 0x80b9, 0x01c3
   }
#else
    4800,
    {
...
static HI_S32 cmos_get_awb_default(AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
    ...
    pstAwbSnsDft->au16GainOffset[3] = 0x1e8;

    pstAwbSnsDft->as32WbPara[0] = 77;
    pstAwbSnsDft->as32WbPara[1] = 67;
    pstAwbSnsDft->as32WbPara[2] = -121;
    pstAwbSnsDft->as32WbPara[3] = 169536;
    pstAwbSnsDft->as32WbPara[4] = 128;
    pstAwbSnsDft->as32WbPara[5] = -120875;
...
HI_U32 cmos_get_isp_black_level(ISP_CMOS_BLACK_LEVEL_S *pstBlackLevel)
{
    ...
    for (i=0; i<4; i++)
    {
        pstBlackLevel->au16BlackLevel[i] = 0xC7; /*12bit,0xC8 */
    }
