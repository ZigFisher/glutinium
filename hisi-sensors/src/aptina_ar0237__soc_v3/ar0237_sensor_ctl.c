...
const unsigned char sensor_i2c_addr  = 0x20; /* I2C Address of AR0237 */
const unsigned int  sensor_addr_byte = 2;    /* ADDR byte of AR0237 */
const unsigned int  sensor_data_byte = 2;    /* DATA byte of AR0237 */
static int g_fd = -1;
...
void sensor_wdr_1080p30_init(HI_VOID);
...
void sensor_linear_1080p30_init(HI_VOID)
{
    ...
    sensor_write_register(0x3012, 0x0451);
    ...
    sensor_write_register(0x3060, 0x0010);
...
void sensor_wdr_1080p30_init(HI_VOID)
{
    ...
    sensor_write_register(0x3012, 0x007d);  //LTime
    sensor_write_register(0x30A2, 0x0001);
    sensor_write_register(0x30A6, 0x0001);
    sensor_write_register(0x30AE, 0x0001);
    sensor_write_register(0x30A8, 0x0001);
    ...
    //  #LOAD= 1.5x analog Gain
    sensor_write_register(0x3060, 0x000f);
    //##
    ...
    sensor_write_register(0x3100, 0x0004);  // T1&T2 use same AGain Reg
    sensor_write_register(0x3060, 0x0004);  //Again
    sensor_write_register(0x312C, 0x0030);
    sensor_write_register(0x3082, 0x0808);
    sensor_write_register(0x3212, 0x007d);  //STime
    delay_ms(33);
