...
#include "i2c.h"
	...
	#include "ar0331_sensor_config_lin.h"
#elif defined(APTAR0331_WDR_CMOS)
	#include "ar0331_sensor_config_wdr.h"
#endif


static const unsigned char sensor_i2c_addr	=	0x20;		/* I2C Address of AR0331 */
