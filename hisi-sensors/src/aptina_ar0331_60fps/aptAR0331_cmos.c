...
static /*__inline*/ cmos_inttime_const_ptr_t cmos_inttime_initialize()
{
	...
	cmos_inttime.lines_per_500ms = 1125*60/2; 
		...
		)
{
	switch(fps)
	{
		default:// default 60fps
		case 60:
			sensor_write_register(0x300C, 0x044C);
			p_inttime->lines_per_500ms = 1125 * 60 / 2;
		break;
		case 50:
			sensor_write_register(0x300C, 0x0528);
			p_inttime->lines_per_500ms = 1125 * 50 / 2;
		break;
		case 30:
			sensor_write_register(0x300C, 0x0898);
			p_inttime->lines_per_500ms = 1125 * 30 / 2;
		break;
		case 25:
			sensor_write_register(0x300C, 0x0A50);
