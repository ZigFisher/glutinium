...
HI_U8 gu8SensorImageMode = SENSOR_3M_1536p_MODE;
...
static AWB_CCM_S g_stAwbCcm =
{
    6315,
    {
        ...
        0x8035, 0x014f, 0x801a,
        0x8002, 0x809d, 0x019f
    },
        
    3810,
    {
        0x01d6, 0x80af, 0x8027,
        0x803e, 0x012e, 0x0010,
        0x8004, 0x80c8, 0x01cc
    },

    2650,
    {
        0x01c8, 0x8076, 0x8052,
        0x8048, 0x0154, 0x800c,
        0x8036, 0x8101, 0x0237
    }
};
...
static HI_S32 cmos_get_awb_default(AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
    ...
    pstAwbSnsDft->au16GainOffset[0] = 0x180;
    pstAwbSnsDft->au16GainOffset[1] = 0x100;
    pstAwbSnsDft->au16GainOffset[2] = 0x100;
    pstAwbSnsDft->au16GainOffset[3] = 0x1ca;

    pstAwbSnsDft->as32WbPara[0] = 37;
    pstAwbSnsDft->as32WbPara[1] = 107;
    pstAwbSnsDft->as32WbPara[2] = -111;
    pstAwbSnsDft->as32WbPara[3] = 200420;
    pstAwbSnsDft->as32WbPara[4] = 128;
    pstAwbSnsDft->as32WbPara[5] = -148673;
