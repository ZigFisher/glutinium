...
#define SHS2_ADDR (0x3023)
#define SHS3_ADDR (0x3026)
#define GAIN_ADDR (0x3014)
#define HCG_ADDR  (0x3009)//[4]
#define VMAX_ADDR (0x3018)//[16:0] linear [19:0]WDR
#define HMAX_ADDR (0x301B)//[15:0]
#define RHS1_ADDR (0x302C)//[19:0]
//#define RHS2_ADDR (0x302F)//[19:0]
#define Y_OUT_SIZE_ADDR (0x3357)

#define INCREASE_LINES (1) /* make real fps less than stand fps because NVR require*/
#define IMX385_VMAX_1080P30_LINEAR  (1125+INCREASE_LINES)
#define IMX385_VMAX_1080P60TO30_WDR (1350+INCREASE_LINES)


/* sensor fps mode */
#define IMX385_SENSOR_1080P_30FPS_LINEAR_MODE  (1)
#define IMX385_SENSOR_1080P_30FPS_WDR_MODE     (2)
#define IMX385_SENSOR_1080P_60FPS_WDR_MODE     (3)
...
HI_U8 gu8SensorImageMode = IMX385_SENSOR_1080P_30FPS_LINEAR_MODE;
HI_U8 genSensorMode = WDR_MODE_NONE;

static HI_U32 gu32BRL = 1097; //BRL                                         

                                         
static HI_U32 gu32RHS1_Max = (IMX385_VMAX_1080P60TO30_WDR - 1097) * 2 - 13;
static HI_U32 gu32FullLinesStd = IMX385_VMAX_1080P30_LINEAR;
static HI_U32 gu32FullLines = IMX385_VMAX_1080P30_LINEAR;
static HI_U32 gu32PreFullLines = IMX385_VMAX_1080P30_LINEAR;
...
static HI_S32 cmos_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch(genSensorMode)
    {
        ...
        case WDR_MODE_NONE:
            ...
            pstAeSnsDft->u32InitExposure = 88346;
        ...
        case WDR_MODE_2To1_LINE:  
			...
			//pstAeSnsDft->u32InitExposure = 454116;
			pstAeSnsDft->u32InitExposure = 66231;
...
static HI_VOID cmos_fps_set(HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    {                
      case IMX385_SENSOR_1080P_30FPS_WDR_MODE:                                                                                  
           if ((f32Fps <= 30) && (f32Fps > 15.21))                                                                            
           {
               u32VMAX = IMX385_VMAX_1080P60TO30_WDR * 25 / f32Fps;  
           }
           else                                                                                                              
           {                                                                                                                 
    ...
    {  
        ...
        g_stSnsRegsInfo.astI2cData[6].u32Data = (u32VMAX & 0xFF);                                                         
        g_stSnsRegsInfo.astI2cData[7].u32Data = ((u32VMAX & 0xFF00) >> 8);                                                
        g_stSnsRegsInfo.astI2cData[8].u32Data = ((u32VMAX & 0x10000) >> 16);                                              
    }                                                                                                                     

    else                                                                                                                  
    {                                                                                                                     
        g_stSnsRegsInfo.astI2cData[9].u32Data = (u32VMAX & 0xFF);                                                         
        g_stSnsRegsInfo.astI2cData[10].u32Data = ((u32VMAX & 0xFF00) >> 8);                                                
        g_stSnsRegsInfo.astI2cData[11].u32Data = ((u32VMAX & 0xF0000) >> 16);                                             
    }                                                                                                                     
    ...
    {                                                                                                                     
        ...
        /*                                                                                                                
            ...
            2n + 5                                                                                                        
            RHS1 <= FSC - BRL*2 -21                                                                                       
            (2 * VMAX_IMX385_1080P30_WDR - 2 * gu32BRL - 21) - (((2 * VMAX_IMX385_1080P30_WDR - 2 * 1109 - 21) - 5) %2)   
            */                                                                                                                
        gu32RHS1_Max = (u32VMAX - gu32BRL) * 2 - 13; 
...
{    
    if(WDR_MODE_2To1_LINE == genSensorMode)
    {
		...
		gu32RHS1_Max = ((u32FullLines >> 1) - gu32BRL) * 2 - 13; 
    }
    else
    {
    ...
    if(WDR_MODE_NONE == genSensorMode)
    {
        ...
        g_stSnsRegsInfo.astI2cData[8].u32Data = ((gu32FullLines & 0x10000) >> 16);
    }
    else if(WDR_MODE_2To1_LINE == genSensorMode)                                                                                     
    {                                                                                         
        g_stSnsRegsInfo.astI2cData[9].u32Data = ((gu32FullLines>>1) & 0xFF);                       
        g_stSnsRegsInfo.astI2cData[10].u32Data = (((gu32FullLines>>1) & 0xFF00) >> 8);              
        g_stSnsRegsInfo.astI2cData[11].u32Data = (((gu32FullLines>>1) & 0xF0000) >> 16);           
    }
    else                                                                                      
    {                                                                                         
    }   
...
static HI_VOID cmos_inttime_update(HI_U32 u32IntTime)
{
    ...
    {                                                                                                 
       ...
       { 
           ...
           u32SHS1 = (u32ShortIntTime % 2) + 3;                                                      
           u32RHS1 = u32ShortIntTime + u32SHS1 ; 
           //printf("au32WDRIntTime[]=%d,%d,%d,%d,%d\n",au32WDRIntTime[0],au32WDRIntTime[1],u32SHS1,u32SHS2,u32RHS1);
           ...
           g_stSnsRegsInfo.astI2cData[6].u32Data = (u32SHS2 & 0xFF);                                 
           g_stSnsRegsInfo.astI2cData[7].u32Data = ((u32SHS2 & 0xFF00) >> 8);                        
           g_stSnsRegsInfo.astI2cData[8].u32Data = ((u32SHS2 & 0xF0000) >> 16); 
                                                                                                      
           g_stSnsRegsInfo.astI2cData[12].u32Data = (u32RHS1 & 0xFF);                                
           g_stSnsRegsInfo.astI2cData[13].u32Data = ((u32RHS1 & 0xFF00) >> 8);                       
           g_stSnsRegsInfo.astI2cData[14].u32Data = ((u32RHS1 & 0xF0000) >> 16);  

           g_stSnsRegsInfo.astI2cData[15].u32Data = (u32YOUTSIZE & 0xFF);                                
           g_stSnsRegsInfo.astI2cData[16].u32Data = ((u32YOUTSIZE & 0x1F00) >> 8);
  ...
  else  //linear mode                                                                                           
  {
      ...
      u32Value = u32Value<2? 2:u32Value;//setting prohibited
      u32Value = u32Value>gu32FullLines-2? gu32FullLines-2:u32Value;//setting prohibited
...
static HI_U32 gain_table[720]=
{
    1024,1036,1048,1060,1072,1085,1097,1110,1123,1136,1149,1162,1176,1189,1203,1217,1231,1245,1260,1274,1289,1304,1319,1334,1350,1366,1381,1397,1414,1430,1446,1463,1480,1497,1515,1532,
    1550,1568,1586,1604,1623,1642,1661,1680,1699,1719,1739,1759,1780,1800,1821,1842,1863,1885,1907,1929,1951,1974,1997,2020,2043,2067,2091,2115,2139,2164,2189,2215,2240,2266,2292,2319,
    2346,2373,2400,2428,2456,2485,2514,2543,2572,2602,2632,2663,2693,2725,2756,2788,2820,2853,2886,2919,2953,2987,3022,3057,3092,3128,3164,3201,3238,3276,3314,3352,3391,3430,3470,3510,
    3551,3592,3633,3675,3718,3761,3805,3849,3893,3938,3984,4030,4077,4124,4172,4220,4269,4318,4368,4419,4470,4522,4574,4627,4681,4735,4790,4845,4901,4958,5015,5073,5132,5192,5252,5313,
    5374,5436,5499,5563,5627,5692,5758,5825,5893,5961,6030,6100,6170,6242,6314,6387,6461,6536,6611,6688,6766,6844,6923,7003,7084,7166,7249,7333,7418,7504,7591,7679,7768,7858,7949,8041,
    8134,8228,8323,8420,8517,8616,8716,8817,8919,9022,9126,9232,9339,9447,9557,9667,9779,9892,10007,10123,10240,10359,10479,10600,10723,10847,10972,11099,11228,11358,11489,11623,11757,
    11893,12031,12170,12311,12454,12598,12744,12891,13041,13192,13344,13499,13655,13813,13973,14135,14299,14464,14632,14801,14973,15146,15321,15499,15678,15860,16044,16229,16417,16607,
    16800,16994,17191,17390,17591,17795,18001,18210,18420,18634,18850,19068,19289,19512,19738,19966,20198,20431,20668,20907,21149,21394,21642,21893,22146,22403,22662,22925,23190,23458,
    23730,24005,24283,24564,24848,25136,25427,25722,26020,26321,26626,26934,27246,27561,27880,28203,28530,28860,29194,29532,29874,30220,30570,30924,31282,31645,32011,32382,32757,33136,
    33520,33908,34300,34698,35099,35506,35917,36333,36754,37179,37610,38045,38486,38931,39382,39838,40300,40766,41238,41716,42199,42687,43182,43682,44188,44699,45217,45740,46270,46806,
    47348,47896,48451,49012,49579,50153,50734,51322,51916,52517,53125,53740,54363,54992,55629,56273,56925,57584,58251,58925,59607,60298,60996,61702,62417,63139,63870,64610,65358,66115,
    66881,67655,68438,69231,70033,70843,71664,72494,73333,74182,75041,75910,76789,77678,78578,79488,80408,81339,82281,83234,84198,85173,86159,87157,88166,89187,90219,91264,92321,93390,
    94471,95565,96672,97791,98924,100069,101228,102400,103586,104785,105999,107226,108468,109724,110994,112279,113580,114895,116225,117571,118932,120310,121703,123112,124537,125980,127438,
    128914,130407,131917,133444,134989,136553,138134,139733,141351,142988,144644,146319,148013,149727,151461,153215,154989,156783,158599,160435,162293,164172,166073,167996,169942,171910,
    173900,175914,177951,180011,182096,184204,186337,188495,190678,192886,195119,197379,199664,201976,204315,206681,209074,211495,213944,216421,218927,221462,224027,226621,229245,231900,
    234585,237301,240049,242829,245640,248485,251362,254273,257217,260196,263209,266256,269339,272458,275613,278805,282033,285299,288602,291944,295325,298745,302204,305703,309243,312824,
    316446,320111,323817,327567,331360,335197,339078,343005,346976,350994,355059,359170,363329,367536,371792,376097,380452,384858,389314,393822,398382,402995,407662,412382,417157,421988,
    426874,431817,436817,441876,446992,452168,457404,462700,468058,473478,478961,484507,490117,495793,501534,507341,513216,519158,525170,531251,537403,543626,549921,556288,562730,569246,
    575838,582505,589250,596074,602976,609958,617021,624166,631393,638704,646100,653582,661150,668806,676550,684384,692309,700326,708435,716638,724936,733331,741822,750412,759102,767892,
    776783,785778,794877,804081,813392,822811,832338,841976,851726,861589,871565,881658,891867,902194,912641,923209,933899,944713,955652,966718,977912,989236,1000691,1012278,1024000,1035857,
    1047852,1059986,1072260,1084676,1097236,1109941,1122794,1135795,1148947,1162251,1175709,1189323,1203095,1217026,1231119,1245374,1259795,1274383,1289140,1304067,1319168,1334443,1349895,
    1365526,1381338,1397333,1413513,1429881,1446438,1463187,1480130,1497269,1514607,1532145,1549887,1567834,1585988,1604353,1622931,1641723,1660734,1679964,1699417,1719095,1739002,1759138,
    1779508,1800114,1820958,1842044,1863374,1884951,1906777,1928857,1951192,1973786,1996641,2019761,2043149,2066807,2090740,2114949,2139439,2164213,2189273,2214624,2240268,2266209,2292450,
    2318996,2345848,2373012,2400490,2428287,2456405,2484849,2513622,2542728,2572172,2601956,2632085,2662563,2693394,2724582,2756132,2788046,2820330,2852988,2886024,2919443,2953248,2987445,
    3022038,3057032,3092431,3128239,3164463,3201105,3238172,3275669,3313599,3351969,3390783,3430046,3469764,3509942,3550585,3591699,3633289,3675361,3717919,3760971,3804521,3848575,3893139,
    3938220,3983822,4029953,//4076617,
};
...
static HI_VOID cmos_again_calc_table(HI_U32 *pu32AgainLin, HI_U32 *pu32AgainDb)
{
    ...
    if (*pu32AgainLin >= gain_table[420])
    {
         *pu32AgainLin = gain_table[420];
         *pu32AgainDb = 420;
         return ;
    }
...
{  
    ...
    if(u32Again >= 61)
    {
        ...
        u32Again = u32Again - 61;
    }
    //printf("u32Again=%d,u32Dgain=%d\n",u32Again,u32Dgain);
    u32Tmp=u32Again+u32Dgain;
        
    g_stSnsRegsInfo.astI2cData[3].u32Data = (u32Tmp & 0xFF);
    g_stSnsRegsInfo.astI2cData[4].u32Data = ((u32Tmp>>8) & 0xF);
    g_stSnsRegsInfo.astI2cData[5].u32Data = (u32HCG & 0xFF);
...
static HI_VOID cmos_get_inttime_max(HI_U32 u32Ratio, HI_U32 u32MinTime, HI_U32 *pu32IntTimeMax, HI_U32 *pu32LFMaxIntTime)
{
    ...
    {                                                                                                                        
        /*  limitation for DOL 2t1                                                                                     
            ...
            ExposureShort + ExposureLong <= FSC - 7                                                                          
            short exposure time <= (FSC - 7) / (ratio + 1)                                                                   
        */
        if(ISP_FSWDR_LONG_FRAME_MODE == genFSWDRMode)
        {
            u32IntTimeMaxTmp0 = gu32PreFullLines - 7 - au32WDRIntTime[0];
		...
		else if(ISP_FSWDR_AUTO_LONG_FRAME_MODE == genFSWDRMode)
        {
			...
			{
				u32IntTimeMaxTmp = gu32PreFullLines - 7 - au32WDRIntTime[0];
			}
			else
			{
				u32IntTimeMaxTmp0 = ((gu32PreFullLines - 7 - au32WDRIntTime[0]) * 0x40)  / DIV_0_TO_1(u32Ratio);                                                                                                                     
            	u32IntTimeMaxTmp = ((gu32FullLines - 7) * 0x40)  / DIV_0_TO_1(u32Ratio + 0x40); 
            	u32IntTimeMaxTmp = (u32IntTimeMaxTmp0 < u32IntTimeMaxTmp) ? u32IntTimeMaxTmp0 : u32IntTimeMaxTmp;
				u32IntTimeMaxTmp0 = gu32FullLines - 7 - (gu32RHS1_Max - 3);
        ...
        else
        {
            ...
            //printf("u32IntTimeMaxTmp = %d,%d\n",u32IntTimeMaxTmp,gu32RHS1_Max - 3);
        }   
    }
    else
    {
...
{  
	...
	3850,
	{
        ...
        2450,
	{ 
            0x010c,  0x8003,  0x8009,
            0x802c,  0x0142,  0x8016,
            0x0014,  0x8033,  0x011f
	}
...
static HI_S32 cmos_get_awb_default(AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
    ...
    pstAwbSnsDft->u16WbRefTemp = 4505;

    pstAwbSnsDft->au16GainOffset[0] = 411;//R
    pstAwbSnsDft->au16GainOffset[1] = 256;//G
    pstAwbSnsDft->au16GainOffset[2] = 256;//G
    pstAwbSnsDft->au16GainOffset[3] = 648;//B

    pstAwbSnsDft->as32WbPara[0] = 130;
    pstAwbSnsDft->as32WbPara[1] = -40;
    pstAwbSnsDft->as32WbPara[2] = -166;
    pstAwbSnsDft->as32WbPara[3] = 159743;
    pstAwbSnsDft->as32WbPara[4] = 128;
    pstAwbSnsDft->as32WbPara[5] = -96588;
...
static ISP_CMOS_YUV_SHARPEN_S g_stIspYuvWdrSharpen = 
{
	...
	/* au8RGain */
    {31,   31,   30,   26,   24,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31},

	/* au8BGain */
    {31,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31,   31},

	/* au8SkinGain */
    {255, 255,  255,  250,  245,  240,  230,  220,  210,  200,  195,  195,  205,  205,  205,  205},
...
#if 1    
	{
    0,21,41,62,82,102,123,143,163,184,204,224,245,265,285,306,326,346,367,387,408,428,449,470,490,511,532,553,574,595,616,638,659,681,702,725,747,769,792,815,838,861,884,907,930,953,976,1000,1023,1046,1069,1092,1115,1138,
    1160,1183,1205,1227,1249,1271,1292,1313,1334,1354,1374,1394,1413,1432,1451,1470,1489,1507,1526,1544,1561,1579,1597,1614,1631,1648,1666,1682,1699,1716,1733,1749,1766,1782,1799,1815,1832,1848,1864,1881,1897,1914,1930,1947,
    1963,1980,1996,2013,2029,2046,2062,2079,2095,2112,2128,2144,2161,2177,2193,2209,2225,2240,2256,2271,2286,2302,2317,2331,2346,2360,2374,2388,2402,2416,2429,2442,2455,2467,2479,2491,2503,2514,2525,2536,2547,2558,2568,2579,
    2589,2599,2609,2619,2629,2639,2649,2659,2669,2679,2689,2699,2709,2719,2729,2740,2750,2761,2772,2783,2794,2805,2816,2827,2838,2849,2860,2871,2882,2893,2904,2915,2926,2937,2948,2959,2970,2982,2993,3004,3016,3027,3039,3051,
    3062,3074,3086,3098,3110,3123,3135,3147,3159,3172,3185,3197,3210,3223,3235,3248,3261,3274,3287,3300,3314,3327,3340,3354,3367,3381,3394,3408,3422,3436,3450,3464,3479,3493,3507,3522,3537,3552,3567,3582,3597,3612,3628,3644,
    3660,3676,3692,3708,3724,3741,3757,3774,3791,3808,3825,3841,3858,3875,3892,3909,3926,3943,3960,3977,3994,4011,4028,4045,4061,4078,4095
	}
#else  /*higher  contrast*/
	{
...
{
	{100,100,150,200,230,235,235,240,245,245,245,245,245,245,245,245},/*au16Strength[16]*/
	{0,  0, 0, 0, 0, 0, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50},/*au16BlendRatio[16]*/
};	
...
static ISP_CMOS_BAYERNR_S g_stIspBayerNrWDR =
{
	...
	/*********************************************/
	{ 140, 110, 110, 140},	
    { 90, 90, 90, 90, 90, 90, 90, 90, 50, 50, 50, 50, 50, 50, 50, 50},    //lutJNLMGain
...
HI_VOID cmos_set_pixel_detect(HI_BOOL bEnable)
{
    ...
    {
        if (IMX385_SENSOR_1080P_30FPS_LINEAR_MODE == gu8SensorImageMode)
        {
...
{                                                                                
    ...
    {                                                                            
        case WDR_MODE_NONE:                                                      
            ...
            gu8SensorImageMode = IMX385_SENSOR_1080P_30FPS_LINEAR_MODE;
            gu32FullLinesStd = IMX385_VMAX_1080P30_LINEAR;
            gu8HCGReg = 0x2; 
            g_stSnsRegsInfo.astI2cData[5].u32Data = 0x2; 
            printf("linear mode\n");                                             
        break;                                                                   
                                                                                 
        case WDR_MODE_2To1_LINE:                                                 
            genSensorMode = WDR_MODE_2To1_LINE;
            gu8SensorImageMode = IMX385_SENSOR_1080P_30FPS_WDR_MODE;
            gu32FullLinesStd = IMX385_VMAX_1080P60TO30_WDR *2 ;                  
            gu32FullLines = IMX385_VMAX_1080P60TO30_WDR *2 ;                     
            gu32BRL = 1109;
            gu8HCGReg = 0x11;
            g_stSnsRegsInfo.astI2cData[5].u32Data = 0x1; 
...
HI_U32 cmos_get_sns_regs_info(ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
    ...
    if (HI_FALSE == bInit)
    {
        ...
        g_stSnsRegsInfo.astI2cData[5].u32RegAddr = HCG_ADDR;    
        ...
        g_stSnsRegsInfo.astI2cData[8].u32RegAddr = VMAX_ADDR + 2;
        ...
        if (WDR_MODE_2To1_LINE == genSensorMode)                                                               
        {
            ...
            g_stSnsRegsInfo.astI2cData[6].u8DelayFrmNum = 0;                                                   
            g_stSnsRegsInfo.astI2cData[6].u32RegAddr = SHS2_ADDR;                                              
            g_stSnsRegsInfo.astI2cData[7].u8DelayFrmNum = 0;                                                   
            g_stSnsRegsInfo.astI2cData[7].u32RegAddr = SHS2_ADDR + 1;                                          
            g_stSnsRegsInfo.astI2cData[8].u8DelayFrmNum = 0;                                                   
            g_stSnsRegsInfo.astI2cData[8].u32RegAddr = SHS2_ADDR + 2; 
                                                                          
            g_stSnsRegsInfo.astI2cData[9].u8DelayFrmNum = 1;                                                   
            g_stSnsRegsInfo.astI2cData[9].u32RegAddr = VMAX_ADDR;                                              
            g_stSnsRegsInfo.astI2cData[10].u8DelayFrmNum = 1;                                                   
            g_stSnsRegsInfo.astI2cData[10].u32RegAddr = VMAX_ADDR + 1;                                          
            g_stSnsRegsInfo.astI2cData[11].u8DelayFrmNum = 1;                                                  
            g_stSnsRegsInfo.astI2cData[11].u32RegAddr = VMAX_ADDR + 2; 
                                                                                          
            g_stSnsRegsInfo.astI2cData[12].u8DelayFrmNum = 1;                                                  
            g_stSnsRegsInfo.astI2cData[12].u32RegAddr = RHS1_ADDR;                                             
            g_stSnsRegsInfo.astI2cData[13].u8DelayFrmNum = 1;                                                  
            g_stSnsRegsInfo.astI2cData[13].u32RegAddr = RHS1_ADDR + 1;                                         
            g_stSnsRegsInfo.astI2cData[14].u8DelayFrmNum = 1;                                                  
            g_stSnsRegsInfo.astI2cData[14].u32RegAddr = RHS1_ADDR + 2; 

            g_stSnsRegsInfo.astI2cData[15].u8DelayFrmNum = 1;                                                  
            g_stSnsRegsInfo.astI2cData[15].u32RegAddr = Y_OUT_SIZE_ADDR;                                             
            g_stSnsRegsInfo.astI2cData[16].u8DelayFrmNum = 1;                                                  
            g_stSnsRegsInfo.astI2cData[16].u32RegAddr = Y_OUT_SIZE_ADDR + 1; 
...
{     
    ...
    genSensorMode = WDR_MODE_NONE;
    gu32FullLinesStd = IMX385_VMAX_1080P30_LINEAR;
    gu32FullLines = IMX385_VMAX_1080P30_LINEAR; 
    bInit = HI_FALSE;
...
int sensor_register_callback(void)
{
    ...
    s32Ret = HI_MPI_AE_SensorRegCallBack(IspDev, &stLib, IMX385_ID, &stAeRegister);
    if (s32Ret)
    {
    ...
    s32Ret = HI_MPI_AWB_SensorRegCallBack(IspDev, &stLib, IMX385_ID, &stAwbRegister);
    if (s32Ret)
    {
...
int sensor_unregister_callback(void)
{
    ...
    s32Ret = HI_MPI_AE_SensorUnRegCallBack(IspDev, &stLib, IMX385_ID);
    if (s32Ret)
    {
    ...
    s32Ret = HI_MPI_AWB_SensorUnRegCallBack(IspDev, &stLib, IMX385_ID);
    if (s32Ret)
    {
