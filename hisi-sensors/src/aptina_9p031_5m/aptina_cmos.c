...
{
	// color matrix[9]
	{	 0x019c,0x8076,0x8026,
	        0x8034,0x01dd,0x80a9,
	        0x8004,0x8059,0x015d,
	},
...
static __inline cmos_inttime_const_ptr_t cmos_inttime_initialize()
{
	...
	cmos_inttime.full_lines_std = 1942;
	cmos_inttime.full_lines_std_30fps = 1943;
	cmos_inttime.full_lines = 1942;
	cmos_inttime.full_lines_del = 1942; //TODO: remove
	cmos_inttime.full_lines_limit = 65535;
	cmos_inttime.max_lines_target = 1942;
	cmos_inttime.min_lines_target = 2;
	cmos_inttime.vblanking_lines = 1942;

	cmos_inttime.exposure_ashort = 0;
	cmos_inttime.exposure_shift = 0;

	cmos_inttime.lines_per_500ms = 13754; // 500ms / 39.17us
