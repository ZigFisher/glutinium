...
/*
	5M resolution: 2592 x 1944 = 5038848
*/
...
#endif
	//sensor_write_register(0x03, 0x0437);	 	// ROW_WINDOW_SIZE_REG=1079
	//sensor_write_register(0x04, 0x077F);	 	// COL_WINDOW_SIZE_REG=1919
	//sensor_write_register(0x09, 0x0400);	 	// INTEG_TIME_REG=1024
...
//	sensor_write_register(0x1e, 0x4006);		// Default LV mode	
	...
	sensor_write_register(0x09, 0x07a4);		//(1) INTEG_TIME_REG		
...
//	sensor_write_register(0x64, 0x000f);		// Blue_Offset
	...
	printf("Aptina MT9P031 sensor 5M fr(%d) init success!\n", framerate);
}
