...
HI_S32 HI_MPI_VENC_SetRefParamEx(VENC_CHN VeChn, const VENC_PARAM_REF_EX_S *pstRefParam);
HI_S32 HI_MPI_VENC_GetRefParamEx(VENC_CHN VeChn, VENC_PARAM_REF_EX_S *pstRefParam);
