...
typedef struct hiDEHAZE_DBG_STATUS_S
{
    ...
    HI_U16 maxdc;
    HI_U32 u32CurFrmNum;
    HI_U8  au8DehazeMinDout[DEFOG_ZONE_NUM];
    HI_U8  Lut[DEHAZE_CURVE_MAX_NODE];
    HI_U8  tmpr_min_flt[DEFOG_ZONE_NUM];
    HI_U8  v_blur_flt_dout[DEFOG_ZONE_NUM];
    HI_U8  pre_dc[DEFOG_ZONE_NUM];
    HI_U8  au32DehazeMaxStatDout[DEFOG_ZONE_NUM];
    HI_U16  flt_a[3]; 
    HI_U16  dc_aver;
