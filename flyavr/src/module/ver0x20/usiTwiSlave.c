...
void usiTwiTransmitWord(uint16_t data)
{
	usiTwiTransmitByte( (data >>  0) & 0xff );
	usiTwiTransmitByte( (data >>  8) & 0xff );
}

void usiTwiTransmitDWord(uint32_t data)
{
	usiTwiTransmitByte( (data >>  0) & 0xff );
	usiTwiTransmitByte( (data >>  8) & 0xff );
	usiTwiTransmitByte( (data >> 16) & 0xff );
	usiTwiTransmitByte( (data >> 24) & 0xff );
}
