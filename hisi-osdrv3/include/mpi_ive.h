...
/*****************************************************************************
*   Prototype    : HI_MPI_IVE_Resize2
*   Description  : Resize.Implement bilinear interpolation. 
*   Parameters   : IVE_SRC_IMAGE_S     astSrc[]			The input source.Only the U8C1/U8C3_PLANAR input format is supported.
*                  IVE_DST_IMAGE_S     astDst[]			Output result.Only the U8C1/U8C3_PLANAR format is supported.
*                  IVE_RESIZE_CTRL_S   *pstResizeCtrl     Control parameter
*   Return Value : HI_SUCCESS: Success;Error codes: Failure.
*   Spec         : The size of the input data ranges from 32x16 pixels to 1920x1080 pixels.
*                  The stride must be 16-pixel-aligned.Call vgs to do.
*   History:
* 
*       1.  Date         : 2016-01-04
*           Author       : 
...
*
*****************************************************************************/
HI_S32 HI_MPI_IVE_Resize2(IVE_SRC_IMAGE_S astSrc[],IVE_DST_IMAGE_S astDst[],IVE_RESIZE2_CTRL_S *pstResize2Ctrl);
