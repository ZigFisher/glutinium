...
extern "C"
{
    ...
    HI_S32 HI_MPI_AI_SetHiFiVqeAttr(AUDIO_DEV AiDevId, AI_CHN AiChn, AI_HIFIVQE_CONFIG_S* pstVqeConfig);
    HI_S32 HI_MPI_AI_GetHiFiVqeAttr(AUDIO_DEV AiDevId, AI_CHN AiChn, AI_HIFIVQE_CONFIG_S* pstVqeConfig);

    HI_S32 HI_MPI_AI_SetTalkVqeAttr(AUDIO_DEV AiDevId, AI_CHN AiChn, AUDIO_DEV AoDevId, AO_CHN AoChn, AI_TALKVQE_CONFIG_S* pstVqeConfig);
