...
#define ISP_REG_BASE        0x113a0000
#define ISP_REG_SIZE        0x3ffff

#define VI_REG_BASE        0x11380000
#define AF_REG_BASE        0x11390000
...
HI_U32 IO_READ16_VI(HI_U32 u32Addr);
HI_S32 IO_WRITE16_VI(HI_U32 u32Addr, HI_U32 u32Value);


#define __IO_CALC_ADDRESS_DYNAMIC_VI(BASE)    (HI_U32)((VI_REG_BASE) + (BASE))
#define IORD_32DIRECT_VI(BASE)             IO_READ32_VI(__IO_CALC_ADDRESS_DYNAMIC_VI(BASE))
#define IOWR_32DIRECT_VI(BASE, DATA)       IO_WRITE32_VI(__IO_CALC_ADDRESS_DYNAMIC_VI(BASE), (DATA))

#define IORD_16DIRECT_VI(BASE)             IO_READ16_VI(__IO_CALC_ADDRESS_DYNAMIC_VI(BASE))
#define IOWR_16DIRECT_VI(BASE, DATA)       IO_WRITE16_VI(__IO_CALC_ADDRESS_DYNAMIC_VI(BASE), (DATA))
