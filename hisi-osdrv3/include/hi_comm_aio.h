...
typedef struct hiAI_DRC_CONFIG_S
{
    ...
    HI_S16  s16AttackTime;   /*time of signal change from large to small (ms), range[10, 250]ms*/
    HI_S16  s16ReleaseTime;  /*time of signal change from small to large (ms), range[10, 250]ms*/
